...
extension VychislyatorDailyCalorieIntakeFormulasListPresenter {
	...
	func didTapSaveButton() {
		...
		userDefaultsFacade.inputedDailyCalorieIntakeSelectedPersonSexIndex = selectedPersonSexIndex
		userDefaultsFacade.inputedDailyCalorieIntakeAgeInYears = inputedAgeInYears
		userDefaultsFacade.inputedDailyCalorieIntakeHeightInCm = inputedHeightInCm
		userDefaultsFacade.inputedDailyCalorieIntakeMassInKg = inputedMassInKg
		userDefaultsFacade.inputedDailyCalorieIntakeSelectedPhysicalActivityIndex = selectedPhysicalActivityIndex
		userDefaultsFacade.calculatedMifflinStJeorKcNormalValue = currentMifflinStJeorKcNormalValue
	...
	func didTapDeleteSavedValues() {
		userDefaultsFacade.inputedDailyCalorieIntakeSelectedPersonSexIndex = nil
		userDefaultsFacade.inputedDailyCalorieIntakeAgeInYears = nil
		userDefaultsFacade.inputedDailyCalorieIntakeHeightInCm = nil
		userDefaultsFacade.inputedDailyCalorieIntakeMassInKg = nil
		userDefaultsFacade.inputedDailyCalorieIntakeSelectedPhysicalActivityIndex = nil
		userDefaultsFacade.calculatedMifflinStJeorKcNormalValue = nil
...
private extension VychislyatorDailyCalorieIntakeFormulasListPresenter {
	...
	func configureUI(changingItemID: VychislyatorDailyCalorieIntakeFormulasListItemIdentifier?) {
		...
		if currentMifflinStJeorKcNormalValue != nil &&
			currentMifflinStJeorKcNormalValue != userDefaultsFacade.calculatedMifflinStJeorKcNormalValue {
	...
	func configureParametersSection(changingItemID: VychislyatorDailyCalorieIntakeFormulasListItemIdentifier?) {
		...
		guard let changingItemID else {
			if inputedAgeInYears != nil && inputedHeightInCm != nil && inputedMassInKg != nil {
