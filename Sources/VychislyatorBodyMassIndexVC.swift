//
//  VychislyatorBodyMassIndexVC.swift
//  Pomogator
//
...
final class VychislyatorBodyMassIndexVC: BaseVC {
	private let presenter: VychislyatorBodyMassIndexPresenter
	...
	private lazy var saveButton = Button(
		fullConfiguration: .init(
			uiConfiguration: Pomogator.defaultButtonConfiguration(
				title: String(localized: "Save body mass index value")
			),
	...
	init(presenter: VychislyatorBodyMassIndexPresenter) {
...
extension VychislyatorBodyMassIndexVC {
	typealias SectionType = VychislyatorBodyMassIndexSection
	...
	func reconfigure(items: [VychislyatorBodyMassIndexItemIdentifier]) {
		var snapshot = tableViewDataSource.snapshot()
		snapshot.reconfigureItems(items)
		tableViewDataSource.apply(snapshot, animatingDifferences: isViewVisible)
	}

	func showSaveBodyMassIndexButton() {
	...
	func hideSaveBodyMassIndexButton() {
		// swiftlint:disable:next trailing_closure
		buttonsView.set(
			isHidden: true,
			animated: isViewVisible,
...
extension VychislyatorBodyMassIndexVC: UITableViewDelegate {
...
private extension VychislyatorBodyMassIndexVC {
	typealias SectionIdentifierType = VychislyatorBodyMassIndexSectionIdentifier
	typealias DataSource = UITableViewDiffableDataSource<SectionIdentifierType, ItemIdentifierType>
	typealias Snapshot = NSDiffableDataSourceSnapshot<SectionIdentifierType, ItemIdentifierType>
	typealias ItemIdentifierType = VychislyatorBodyMassIndexItemIdentifier
	...
	func setupUI() {
		...
		navigationItem.title = String(localized: "Body mass index")
